...
function debounce(func, ms) {
  ...
  class Slider {
    ...
    // Элементы слайдера
    #sliderItems = document.querySelectorAll(".slider1__item");
    // Первый элемент слайдера
    #firstSliderItem = this.#sliderItems[0];
    #SecondSliderItem = this.#sliderItems[1];
    #ThreeSliderItem = this.#sliderItems[2];
    #FourSliderItem = this.#sliderItems[3];
    #FiveSliderItem = this.#sliderItems[4];

    // Последний элемент слайдера
    #lastSliderItem = this.#sliderItems[this.#sliderItems.length - 1];
    #last2SliderItem = this.#sliderItems[this.#sliderItems.length - 2];
    #last3SliderItem = this.#sliderItems[this.#sliderItems.length - 3];
    #last4SliderItem = this.#sliderItems[this.#sliderItems.length - 4];
    #last5SliderItem = this.#sliderItems[this.#sliderItems.length - 5];
    ...
    #sliderElemWidth = document.querySelectorAll(".slider1__item")[0].offsetWidth;
    /**
    ...
    constructor() {
      ...
      this.#slider.insertAdjacentElement(
        "afterbegin",
        this.#last2SliderItem.cloneNode(true),
      );
      this.#slider.insertAdjacentElement(
        "afterbegin",
        this.#last3SliderItem.cloneNode(true),
      );
      this.#slider.insertAdjacentElement(
        "afterbegin",
        this.#last4SliderItem.cloneNode(true),
      );
      ...
      this.#slider.insertAdjacentElement(
        "beforeend",
        this.#SecondSliderItem.cloneNode(true),
      );
    ...
    #onWindowResize = () => {
      ...
      this.slideWidth = document.querySelectorAll(".slider1__item")[0].offsetWidth;
